...
```bash
> docker run --rm -p "8004:8004" becorecode/curso-intro-docker-modulo-4:latest
```

Una vez levantado el contenedor, accede con un navegador web a `http://localhost:8004`
...
* Para imprimirlas:
  * Accede a la URL `http://localhost:8004/?print-pdf`
  * Imprime la página 
  * Si deseas añadir las notas del presentador utiliza la URL  `http://localhost:8004/?print-pdf&showNotes=true`
